...
import 'package:green_cycle_fyp/view/auth/signup_screen.dart' as _i16;
...
import 'package:green_cycle_fyp/view/customer/reward/reward_screen.dart'
    as _i15;
import 'package:green_cycle_fyp/view/onboarding_screen.dart' as _i11;
...
class AwarenessDetailsRoute extends _i17.PageRouteInfo<void> {
  const AwarenessDetailsRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i2.AwarenessScreen]
class AwarenessRoute extends _i17.PageRouteInfo<void> {
  const AwarenessRoute({List<_i17.PageRouteInfo>? children})
      : super(
          AwarenessRoute.name,
          initialChildren: children,
        );
...
class CollectorAdditionalSignupRoute extends _i17.PageRouteInfo<void> {
  const CollectorAdditionalSignupRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
class CompletedRequestRoute extends _i17.PageRouteInfo<void> {
  const CompletedRequestRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
class CustomBottomNavBar extends _i17.PageRouteInfo<void> {
  const CustomBottomNavBar({List<_i17.PageRouteInfo>? children})
      : super(
...
class MarketplaceRoute extends _i17.PageRouteInfo<void> {
  const MarketplaceRoute({List<_i17.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i12.PointsScreen]
class PointsRoute extends _i17.PageRouteInfo<void> {
  const PointsRoute({List<_i17.PageRouteInfo>? children})
      : super(
          PointsRoute.name,
          initialChildren: children,
        );
