...
import 'package:green_cycle_fyp/view/auth/collector_additional_signup_screen.dart'
    as _i5;
import 'package:green_cycle_fyp/view/auth/login_screen.dart' as _i12;
import 'package:green_cycle_fyp/view/auth/signup_screen.dart' as _i22;
...
import 'package:green_cycle_fyp/view/customer/reward/reward_screen.dart'
    as _i21;
import 'package:green_cycle_fyp/view/onboarding_screen.dart' as _i17;
...
abstract class $AppRouter extends _i23.RootStackRouter {
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ...
    ItemDetailsRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i11.ItemDetailsScreen(),
      );
    },
    ...
    MarketplaceCategoryRoute.name: (routeData) {
      ...
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i13.MarketplaceCategoryScreen(
          key: args.key,
    ...
    MarketplaceRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i14.MarketplaceScreen(),
      );
    },
    MyListingRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i15.MyListingScreen(),
      );
    },
    MyPurchasesRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i16.MyPurchasesScreen(),
      );
    },
    ...
    RequestRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i20.RequestScreen(),
      );
    },
    RewardRoute.name: (routeData) {
      return _i23.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i21.RewardScreen(),
      );
    },
...
class AwarenessDetailsRoute extends _i23.PageRouteInfo<void> {
  const AwarenessDetailsRoute({List<_i23.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i2.AwarenessScreen]
class AwarenessRoute extends _i23.PageRouteInfo<void> {
  const AwarenessRoute({List<_i23.PageRouteInfo>? children})
      : super(
          AwarenessRoute.name,
          initialChildren: children,
        );
...
class CollectorAdditionalSignupRoute extends _i23.PageRouteInfo<void> {
  const CollectorAdditionalSignupRoute({List<_i23.PageRouteInfo>? children})
      : super(
...
class CompletedRequestRoute extends _i23.PageRouteInfo<void> {
  const CompletedRequestRoute({List<_i23.PageRouteInfo>? children})
      : super(
...
class CreateListingRoute extends _i23.PageRouteInfo<void> {
  const CreateListingRoute({List<_i23.PageRouteInfo>? children})
      : super(
...
class CustomBottomNavBar extends _i23.PageRouteInfo<void> {
  const CustomBottomNavBar({List<_i23.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i11.ItemDetailsScreen]
class ItemDetailsRoute extends _i23.PageRouteInfo<void> {
  const ItemDetailsRoute({List<_i23.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i13.MarketplaceCategoryScreen]
class MarketplaceCategoryRoute
    extends _i23.PageRouteInfo<MarketplaceCategoryRouteArgs> {
  ...
  static const _i23.PageInfo<MarketplaceCategoryRouteArgs> page =
      _i23.PageInfo<MarketplaceCategoryRouteArgs>(name);
}
...
/// generated route for
/// [_i14.MarketplaceScreen]
class MarketplaceRoute extends _i23.PageRouteInfo<void> {
  const MarketplaceRoute({List<_i23.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i15.MyListingScreen]
class MyListingRoute extends _i23.PageRouteInfo<void> {
  const MyListingRoute({List<_i23.PageRouteInfo>? children})
      : super(
          MyListingRoute.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i16.MyPurchasesScreen]
class MyPurchasesRoute extends _i23.PageRouteInfo<void> {
  const MyPurchasesRoute({List<_i23.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i18.PointsScreen]
class PointsRoute extends _i23.PageRouteInfo<void> {
  const PointsRoute({List<_i23.PageRouteInfo>? children})
      : super(
          PointsRoute.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i20.RequestScreen]
class RequestRoute extends _i23.PageRouteInfo<void> {
  const RequestRoute({List<_i23.PageRouteInfo>? children})
      : super(
          RequestRoute.name,
          initialChildren: children,
        );
